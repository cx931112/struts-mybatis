...
<script	type="text/javascript">
  ...
  <body class="page-header-fixed">
			...
			<div class="header-inner" style="padding: 2px 40px;">
				...
				<div class="nav navbar-nav pull-right">
		            ...
		            <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button">
		            	...
		            	<span>欢迎您：<label id="label">${sessionScope.userName}</label></span>
		...
		<div class="page-container">
					...
					<div class="panel panel-default">
						...
						<div id="collapseThree" class="panel-collapse collapse">
							<div class="panel-body">
								<ul>
									<li><a href="javascript:;" onclick="changePage('allTest.do')">考试报名</a></li>
									<li><a href="javascript:;" onclick="changePage('HaveApplyTest.do')">已报科目</a></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<!--主界面开始 -->
			<iframe id="mainFrm" style="border: none;width: 73%;height: 80%;" src="allTest.do"></iframe>
			<!-- 主界面结束 -->
